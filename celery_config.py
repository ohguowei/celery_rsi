...
# AUD/SGD is 2000/6*13.5
# AUD/USD is 2000/6*13.5

# Define bot configurations
bots = [
    {"name": "bot1_AUDUSD","accountID": "001-003-255162-005","access_token": "c33734921cd0b7b68c721fc18e2019c2-8cfd11c75b7df0c81301e2cf58846540","currencies": ["AUD_USD"],"lot_size": 4500,"environment": "live","weight": 7,"profit": 20},
#    {"name": "bot2_USDCHF","accountID": "001-003-255162-004","access_token": "c33734921cd0b7b68c721fc18e2019c2-8cfd11c75b7df0c81301e2cf58846540","currencies": ["USD_CHF"],"lot_size": 24750,"environment": "live","weight": 7,"profit": 110},
    {"name": "bot3_AUDSGD","accountID": "001-003-255162-003","access_token": "c33734921cd0b7b68c721fc18e2019c2-8cfd11c75b7df0c81301e2cf58846540","currencies": ["AUD_SGD"],"lot_size": 4500,"environment": "live","weight": 7,"profit": 20},  
    {"name": "botgx","accountID": "001-003-134550-004","access_token": "bdab89dd6c283090118076c791718acf-de61f5e32199b4079839597767fbf3d3","currencies": ["AUD_SGD","AUD_USD"],"lot_size": 257,"environment": "live","weight": 7,"profit": 2.3},    
]
...
for bot in bots:
    ...
    beat_schedule[f'{bot_name}_close_saturday'] = {
        'task': 'celery_close.close_positions',
        'schedule': crontab(minute='*', hour='0-23', day_of_week='sun'),
        'args': (bot["accountID"], bot["access_token"], bot["profit"]),
    } 
